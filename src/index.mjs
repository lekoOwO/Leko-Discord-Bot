...
client.once(Discord.Events.ClientReady, async c => {
    ...
    console.log(`Join bot to your server: https://discord.com/api/oauth2/authorize?client_id=${config.discord.clientId}&permissions=277025410112&scope=bot%20applications.commands`)
